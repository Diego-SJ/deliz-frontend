...
import { OPERATION_TYPE_NAME, getColorName, getImageType } from '../current-cashier/open-cashier';
          ...
          >
            ...
            <div className="flex flex-col px-4">
              <div className="flex justify-between py-1 ">
                <Typography.Text className="m-0 text-base" type="secondary">
                  Monto inicial
                </Typography.Text>
                <Typography.Text className="m-0 text-base" type="secondary">
                    ...
                    <div className="flex justify-between w-full px-4">
                      <div className="flex gap-4 ">
                        ...
                        <div className="flex flex-col">
                          ...
                          <Typography.Text className="text-sm font-light" type="secondary">
                            {item.name || '- - -'}
                          </Typography.Text>
                        </div>
                      </div>
